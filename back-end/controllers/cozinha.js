...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Cozinha.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Cozinha.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        const id = req.body._id
        let obj = await Cozinha.findByIdAndDelete(id)
